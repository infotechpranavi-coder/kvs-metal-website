...
import { ChatIcon, ChevronUpIcon } from './UniIcons'

const PHONE = '+911234567890'
const WHATSAPP_URL = 'https://wa.me/911234567890'
const BROCHURE_URL = '/brochure/kvs-metal-brochure.pdf'
...
export function UniWidgets() {
  ...
  return (
    <>
      <div className="uniFloatActions" aria-label="Quick contact">
        ...
        <a
          ...
          download="KVS-Metal-Brochure.pdf"
